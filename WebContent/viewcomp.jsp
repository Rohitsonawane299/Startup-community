 ...
 try 
	{
		...
		PreparedStatement ps1=con.prepareStatement("select * from company_reg where statuse=?");
 ...
 %>
        <tbody>
          <tr class="selected">
            ...
            <td><a href="approve.jsp?ano=<%=r1.getString(1)%>"><button>Approve</button></a></td>
           </tr>
           <%
		}
	}
