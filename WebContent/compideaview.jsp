 ...
 try 
	{
		...
		PreparedStatement ps1=con.prepareStatement("select * from company_data where cmail=?");
 ...
 %>
        <tbody>
          <tr class="selected">
           ...
           <td><a href="deletepro.jsp?del=<%=r1.getString(1)%>"><button>Delete</button></a></td>
