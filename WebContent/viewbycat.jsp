...
<body>
 ...
 String categoury=request.getParameter("ctype");
 ...
 try 
	{
		...
		PreparedStatement ps1=con.prepareStatement("select * from company_data where categoury=?");
		ps1.setString(1,categoury);
 ...
 %>
        <tbody>
          <tr class="selected">
            ...
            <td><a href="apply.jsp?ap1=<%=r1.getString(2)%>&ap2=<%=r1.getString(8)%>" ><button>APPLY</button></a></td>
               </tr>
           <%
		}
	}
